...
![Home — Hebrew/RTL pharmacy storefront](home.png)

![Product catalog — categories, stock status, add-to-cart](products.png)

![Category browsing across six pharmacy categories](categories.png)

![Contact CTA and footer](footer.png)
...
| Layer | Choice |
|---|---|
| **Front-end** | React 19 (SPA) + React Router 7 |
| **Build** | Vite |
| **Styling** | Hand-written CSS (~1,900 lines), custom design system — no framework |
| **Motion** | Framer Motion |
| **Backend** | Node.js + Express |
| **Database** | MongoDB (Mongoose) — `Product` model, auto-seeds 26 products |
| **Auth** | JWT (admin only) |
| **Order delivery** | Nodemailer (email) + WhatsApp deep-link |
| **Deploy** | Vercel (serverless API + static build) |
